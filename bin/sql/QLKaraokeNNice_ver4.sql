...
INSERT [dbo].[KhachHang] ([HoTen], [SDT], [Email], [NamSinh], [SLDatPhong])
	VALUES (N'Lê Thị Phương Xa', '0908782212', 'lethiphuongxa@gmail.com', 1993, 0)
GO
...
select *from HoaDon
SELECT * FROM NhanVien WHERE TrangThai LIKE N'Đang làm việc'

select SUM(SLDatPhong) from KhachHang
