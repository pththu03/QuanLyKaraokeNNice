...
public class ManHinhDatPhong extends JPanel {
	...
	public ManHinhDatPhong() {
		...
		panel_TimKiem.setBounds(0, 0, 616, 126);
		...
		model_comboLoaiPhong = new DefaultComboBoxModel<>(new String[] { "Tất cả", "Thường", "VIP" });
		...
		btn_TimKiemPhong.setBounds(497, 15, 40, 35);
		...
		model_comboSucChua = new DefaultComboBoxModel<>(new String[] { "Tất cả", "5 người", "10 người", "20 người" });
		...
		btn_LamMoi.setBackground(new Color(0, 255, 204));
		...
		panel_DSPhong.setBackground(new Color(153, 204, 255));
		...
		lbl_GiaPhong = new JLabel("Giải pháp:");
		...
		btn_TimKiemSDTKhachHang.setBackground(new Color(175, 238, 238));
		...
		btn_HuyPhong.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		...
		btn_DoiPhong.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		...
		btn_DatPhong.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
	...
	public void chonChucNangDatPhong() {
		if(JOptionPane.showConfirmDialog(null, "Có đặt dịch vụ ngay không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
