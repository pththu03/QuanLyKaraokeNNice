...
public class GD_DoiMatKhau extends JDialog {
	...
	public GD_DoiMatKhau(NhanVienEntity nhanVienEntity) {
		...
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(GD_DoiMatKhau.class.getResource("/images/iconLogo1.png")));
	...
	public void chonChucNangXemMKCu() {
		xemMKCu = !xemMKCu;
		if (xemMKCu) {
			btnMatKhauCu.setIcon(new ImageIcon(GD_DoiMatKhau.class.getResource("/images/iconKhongNhinMK.png")));
	...
	public void chonChucNangXemMKMoi() {
		xemMKMoi = !xemMKMoi;
		if (xemMKMoi) {
			btnMatKhauMoi.setIcon(new ImageIcon(GD_DoiMatKhau.class.getResource("/images/iconKhongNhinMK.png")));
	...
	public void chonChucNangXemLaiMK() {
		xemLaiMK = !xemLaiMK;
		if (xemLaiMK) {
			btnNhapLaiMK.setIcon(new ImageIcon(GD_DoiMatKhau.class.getResource("/images/iconKhongNhinMK.png")));
